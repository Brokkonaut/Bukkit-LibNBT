...
public final class InstanceChunkLoader implements IChunkLoader, IAsyncChunkSaver {
    ...
    @Override
    public void saveChunk(net.minecraft.server.v1_13_R1.World world, IChunkAccess chunk) throws IOException, ExceptionWorldConflict {
        saveLoader.saveChunk(world, chunk);
    }

    @Override
    public void a(net.minecraft.server.v1_13_R1.IBlockAccess world, Chunk chunk) throws IOException {
